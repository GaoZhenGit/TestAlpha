 ...
 */
public class GLVideoRenderer implements GLSurfaceView.Renderer, MediaPlayer.OnVideoSizeChangedListener, SurfaceTexture.OnFrameAvailableListener {
	...
	public void onSurfaceCreated(GL10 gl, EGLConfig config) {
		...
		ShaderFactory.INSTANCE.checkError();
